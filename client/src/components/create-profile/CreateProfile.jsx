...
class CreateProfile extends Component {
  ...
  onSubmitFiredAction = e => {
    ...
    const profileData = {
      ...
      status: this.state.skills,
      skills: this.state.skills,
      githhubusername: this.state.githhubusername,
      bio: this.state.bio,
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmitFiredAction}>
                ...
                />
                <TextFeildGroup
                  placeholder="githhubusername"
                  name="githhubusername"
                  value={this.state.githhubusername}
                  onChange={this.onInputChange}
                  errors={errors.githhubusername}
